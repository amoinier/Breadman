...
{
    vie = vie + 20; // Récupère '20' de vie.
    if (vie > 100){ // Sans dépasser '100' de vie.
        vie = 100;
    }
}
...
void Personnage::attaquer(Personnage &cible){ // On utilise un poiteur vers la cible indiquer en parametre.
